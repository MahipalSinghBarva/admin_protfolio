              ...
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <input
                      type="text"
                      className="block flex-1 border bg-white py-2.5 pl-1 px-5 text-gray-900 w-full placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <input
                      type="text"
                      className="block flex-1 border bg-white py-1.5 pl-1 text-gray-900 w-full placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <input
                      type="text"
                      className="block flex-1 border bg w-full py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                      placeholder="Github Repository Link"
                      value={projectLink}
