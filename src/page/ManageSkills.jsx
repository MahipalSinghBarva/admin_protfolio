      ...
      <Tabs defaultValue="week">
        <TabsContent value="week">
          <Card>
            ...
            <CardContent className="grid sm:grid-cols-2 gap-4 mt-5">
              {skills?.skill?.map((element) => {
                return (
                  <Card key={element._id}>
                    <CardHeader className="text-xl font-bold flex items-center justify-between flex-row">
                      Skill Name: {element.title}
                      <TooltipProvider>
                        <Tooltip>
